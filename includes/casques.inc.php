...
while ($ligne = $res->fetch(PDO::FETCH_OBJ)) {
    ...
    echo '<p id="p.prix">',$ligne->prix, '€','</p>','<p id="p.',afficheStock($stock),'">',afficheStock($ligne->stock),'</p>','<p id="p.marque">', $ligne->nom,'</p>','<p id="p.modele">', $ligne->modele,'</p>','<p id="img.classement">', $ligne->classement,'</p>';
    echo '</article>';
}
